  ...
  return (
    <Container>
      ...
      <View style={styles.row}>
        <TouchableOpacity onPress={() => {navigation.navigate("Auth", { screen: "CreateAccount_Mentor" })}} style={styles.item}>
        ...
        <TouchableOpacity onPress={() => {navigation.navigate("Auth", { screen: "CreateAccount_Mentee" })}} style={styles.item}>
          <View style={styles.circle}>
